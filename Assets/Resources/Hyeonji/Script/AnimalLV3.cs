...
public class AnimalLV3 : MonoBehaviour
{
    ...
    public Transform[] Animals4 = new Transform[3]; // 4단계 동물 프리펩
    ...
    void Start()
    {
        ...
        // 동물설정
        Animals4[0] = AllAnimals[CompletionBtnClick.AnimalNumber1];
        Animals4[1] = AllAnimals[CompletionBtnClick.AnimalNumber2];
        Animals4[2] = AllAnimals[CompletionBtnClick.AnimalNumber3];
    }
        ...
        for (int i = 0; i < rayDown.Length; i++)
        {
            ...
            if (rayDown[i].collider.gameObject.tag == this.transform.tag)
            {
                ...
                if (isDestroy == 2)
                {
                    ...
                    int RandomAnimal = Random.Range(0, Animals4.Length);
